...
So when I see `cubic-bezier(x1, y1, x2, y2)` now, I picture two handles on a time–progress graph and ask: how should this motion leave, where should it accelerate, and how should it arrive?
